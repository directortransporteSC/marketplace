...
-- =============================================
-- ACTUALIZACIÓN: Campo "vendido" para vehículos
-- Ejecuta esto en Supabase → SQL Editor
-- =============================================
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS sold boolean DEFAULT false;

-- Actualizar política para que clientes vean TODOS (disponibles y vendidos)
-- Los disponibles aparecen primero, los vendidos al final
-- Para marcar un vehículo como vendido desde el admin:
-- UPDATE vehicles SET sold = true WHERE id = 'uuid-del-vehiculo';
